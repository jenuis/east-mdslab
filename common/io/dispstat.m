function varargout = dispstat(TXT,varargin)
% https://ww2.mathworks.cn/matlabcentral/fileexchange/44673-overwritable-message-outputs-to-commandline-window
...
isinit = 0; % is it initialized?
clean = 0; % clean global variable
...
if isinit
    varargout{1} = ~isempty(prevCharCnt);
    return;
end
if clean
    clear prevCharCnt
